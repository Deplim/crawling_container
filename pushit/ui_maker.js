...
var ui_html6=`<div id="ui_html6">
		<div id="insert_option">
			<table id="insert_option_table">
		        <tbody>
			        <tr>
			          <td class="td">title<br><br><input id="insert_title" type="text" class="input" value="default"></td>
			          <td class="td">content<br><br><input id="insert_content" type="text" class="input" value="default"></td>
			        </tr>
			        <tr>
			          <td class="td">targetUrl<br><br><input id="insert_targetUrl" type="text" class="input"></td>
			          <td class="td">tag<br><br><input id="insert_tag1" type="text" class="input"></td>
			        </tr>
		        </tbody>
			</table>
		</div>				
...
load_img.src="https://github.com/Deplim/crawling_container/blob/master/icon/Loading.gif?raw=true"
...
function dragMouseDown(event, target) {
    ...
    function moveAt(pageX, pageY) {
    	target_left=pageX - shiftX
    	target_top=pageY - shiftY

    	if(target_left<0 || target_left>($(document).width()-300)||target_top<0 || target_top>(window.innerHeight-400)){
    		return
    	}
...
for (var i=0; i<property_option.length; i++){
	...
	temp_el.style="width:50%; height:30px; font-size:14px; background-color:white; color:black; border:initial; border-radius:0px;"
