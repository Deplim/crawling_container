...
chrome.runtime.onMessage.addListener( function(request, sender, sendResponse) {
	...
	else if(request.data=="keydown"){	
		var event = document.createEvent("Events");
		event.initEvent('keydown', true, true);
		event.keyCode = request.keyCode;
...
function extract_css_selector(el){
	...
	if(template_data['item_selector']!=""){
		item_element=document.querySelector(template_data['item_selector'])
	}

	while ((el.nodeType === Node.ELEMENT_NODE) && (el!=item_element)) {
